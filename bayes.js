...
function bayes() {
    ...
    .on('end', () => {
        ...
        console.log("Unorthodox Characters in ham: " + featureCounts.get(1).ham);
        console.log("Unorthodox Characters in spam: " + featureCounts.get(1).spam);
        console.log("Too many capital Characters in ham: " + featureCounts.get(2).ham);
        console.log("Too many capital Characters in spam: " + featureCounts.get(2).spam);
        console.log("Link in ham: " + featureCounts.get(3).ham);
        console.log("Link in spam: " + featureCounts.get(3).spam);
        //P(spam)
        ...
        for (var feature of featureCounts) {
            ...
            // //P(F1 = no | ham)
            feature[1].probNoGivenHam = 1 - feature[1].probYesGivenHam;
        }
        console.log(featureCounts);
        // ////F1**************************************************************************
        // //P(F1 = yes | spam)
